            ...
            <div class="d-flex align-items-stretch flex-wrap">
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                    <div class="m-3 p-4">
                        ...
                        <h4 class="text-dark font-weight-normal">Welcome to <span class="font-weight-bold">Flutter Intensive Class</span>
                        </h4>
                        ...
                        <div class="text-small mt-5 text-center">
                            Copyright &copy; Flutter Intensive Club 2024. Made with 💙 by Stisla
                            <div class="mt-2">

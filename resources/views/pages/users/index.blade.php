    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                ...
                <h2 class="section-title mt-n2">Users</h2>
                <p class="section-lead mb-n4"> <!-- Apply negative margin to bottom (mb) -->
                                        ...
                                        <tbody>
                                            @foreach ($users as $user)
                                                <tr>
                                                    ...
                                                    <td>{{ $user->email }}</td>
                                                    <td>{{ $user->phone }}</td>
                                                    <td>{{ \Carbon\Carbon::parse($user->created_at)->format('Y-m-d H:i:s') }}
                                                    </td>
                                                    <td>{{ $user->role }}</td>
                                                    <td>
